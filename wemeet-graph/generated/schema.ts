...
export class Event extends Entity {
  ...
  set eventId(value: Bytes | null) {
    if (!value) {
      this.unset("eventId");
    } else {
      this.set("eventId", Value.fromBytes(<Bytes>value));
    }
  }
  ...
  get eventStartTimestamp(): BigInt {
    let value = this.get("eventStartTimestamp");
    return value!.toBigInt();
  }

  set eventStartTimestamp(value: BigInt) {
    this.set("eventStartTimestamp", Value.fromBigInt(value));
  }

  get eventEndTimestamp(): BigInt {
    let value = this.get("eventEndTimestamp");
    return value!.toBigInt();
  }

  set eventEndTimestamp(value: BigInt) {
    this.set("eventEndTimestamp", Value.fromBigInt(value));
  }
  ...
  get refundPaidOut(): boolean {
    let value = this.get("refundPaidOut");
    return value!.toBoolean();
  }

  set refundPaidOut(value: boolean) {
    this.set("refundPaidOut", Value.fromBoolean(value));
  }
  ...
  get confirmedRSVPs(): Array<string> | null {
    let value = this.get("confirmedRSVPs");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toStringArray();
  ...
  set confirmedRSVPs(value: Array<string> | null) {
    if (!value) {
      this.unset("confirmedRSVPs");
    } else {
      this.set("confirmedRSVPs", Value.fromStringArray(<Array<string>>value));
    }
  }
}
...
export class Account extends Entity {
  ...
  get totalAttendedEvent(): BigInt {
    let value = this.get("totalAttendedEvent");
    return value!.toBigInt();
  }

  set totalAttendedEvent(value: BigInt) {
    this.set("totalAttendedEvent", Value.fromBigInt(value));
  }
